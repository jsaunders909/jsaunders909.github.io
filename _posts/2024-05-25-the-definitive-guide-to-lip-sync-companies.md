...
![](https://cdn-images-1.medium.com/max/800/1*dRkm0ID_nanT5De1cfRdcA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*CYQvpQ0prDMRSTPOoAxUTA.png)

[Synthesia](https://www.synthesia.io/?via=jack-saunders) is by far the largest player in the market, valued at over $1bn. With a research team putting out several top-tier papers every year, the tech is only going to get better. It’s a bit costly, but the quality is getting very good.
...
**The tech:** Early Synthesia was almost certainly built around [deferred neural rendering](https://www.flawlessai.com/). Recently, their associated tech team has been focusing on [Neural Parametric Head models;](https://github.com/SimonGiebenhain/NPHM#learning-neural-parametric-head-models-nphm) I expect they’ll be using them soon if they aren’t yet. Overall, Synthesia has the most mature tech.

[**Try them out here**](https://www.synthesia.io/?via=jack-saunders)**(aff)**

### HeyGen

![](https://cdn-images-1.medium.com/max/800/1*PD-nkP0w5jFffvpRDlthkg.png)

**What they do:**[HeyGen](https://heygen.com/?sid=rewardful&via=jack-saunders) describes its offering as “Visual Storytelling.” In reality, this is also the AI avatar market for sales, marketing, and training videos. HeyGen has focused more on custom avatars, but it’s also starting to offer real-time avatars.
...
[**Try them out here**](https://heygen.com/?sid=rewardful&via=jack-saunders)

### Flawless

![](https://cdn-images-1.medium.com/max/800/1*pLLgIbTIdquNzmsK8-WcnQ.png)
...
**The tech:**Most of the marketing material shows 3D models overlayed on the face. This means they are probably using some [3DMM-based model.](https://medium.com/@jacksaunders909/person-specific-deepfakes-with-3d-morphable-models-1df9618b9f6a)

[**Try them out here**](https://www.flawlessai.com/)

### DeepReel

![](https://cdn-images-1.medium.com/max/800/1*QZEeaa8e_UIVTfMBnHOR8A.png)

**What they do:**[DeepReel](https://www.deepreel.com/) is another AI avatar company and one that I am quite biased towards, having worked on the tech myself in the past. They offer avatars for sales and marketing campaigns with integrations into Canva and Abode Express.
...
**The tech:**As I once worked here, I can’t divulge too much. But from [papers I have published](https://dubbingforeveryone.github.io/) with them publicly, I can say the tech is 3DMM-based.

[**Try them out here**](https://www.deepreel.com/)

### Colossyan

![](https://cdn-images-1.medium.com/max/800/1*IEry-1hv_1H1h8byWpDySw.png)

**What they do:** [Colossyan](https://www.colossyan.com/?via=jack) offers AI presenters focused on internal communications and education. They also have a feature that converts PDF or PowerPoint documents into AI avatar videos.
...
[**Try them out here**](https://www.colossyan.com/?via=jack)**(aff)**

### Pipio

![](https://cdn-images-1.medium.com/max/800/1*U24Mj_Hjtw327LnxqM7QMg.png)

**What they do:**[Pipio](https://pipio.ai/?via=jack) offer AI avatars for sales and marketing, as well as internal communications.
...
[**Try them out here**](https://pipio.ai/?via=jack)**(aff)**

### SyncLabs

![](https://cdn-images-1.medium.com/max/800/1*awoHMLoY-RK1DwgFSN9m3g.png)

[SyncLabs](https://synclabs.so/) is a YC-backed company spun out by the creators of [Wav2Lip.](https://medium.com/@jacksaunders909/wav2lip-generalized-lip-sync-models-e0effc4e8ed3) It is likely heavily influenced by their follow-up research work. It is on the cheaper end of available models, with more flexibility but generally lower quality.
...
**The tech:**As Synclabs is spun out by the Wav2Lip authors, it is almost certain that it builds on this line of tech. Most likely is it related to [Wav2LipHQ,](https://medium.com/towards-artificial-intelligence/towards-generating-ultra-high-resolution-talking-face-videos-with-lip-synchronization-1c7761374dfc) although with significant modifications**.**

[**Try them out here**](https://synclabs.so/)

### D-ID

![](https://cdn-images-1.medium.com/max/800/1*RC61pbKSqpnaiXdRwYpobw.png)

**What they do:**[D-ID](https://www.d-id.com/) are one of the first companies in the field. They target training videos, sales and marketing, although you might be familiar with some of the TikTok memes made with their early tech.
...
[**Try them out here**](https://www.d-id.com/)

### Tavus

![](https://cdn-images-1.medium.com/max/800/1*OqOD1ReI7HIsQrIA6xgwhw.png)

**What they do:**[Tavus](https://www.tavus.io/privacy-policy) provides AI replicas, with a focus on custom avatars for sales, marketing, education, and social media. They also emphasize APIs for developers to integrate Tavus’ replicas into their products.
...
**The tech:**One nice thing about Tavus is that they have been very open about their tech stack. [A medium article by one of their employees](https://medium.com/@christiansafka/realistic-avatar-generation-in-the-wild-text-to-video-03de52b5ceda) goes into detail, but TL;DR: They use a 3DMM plus NeRFs (switching to Gaussian Splatting) and GANs.

[**Try them out here**](https://www.tavus.io/privacy-policy)

### GanAI

![](https://cdn-images-1.medium.com/max/800/1*YGeDnBvt6rmORi466njSmw.png)

**What they do:**[GAN AI](https://gan.ai/) also offers avatars that focus on replacing single words rather than generating entire sentences. This works well for things like email campaigns.
...
[**Try them out here**](https://gan.ai/)

### VEED IO

![](https://cdn-images-1.medium.com/max/800/1*FNEql5Zfccxz2qHProIx8w.png)

**What they do:**[VEED IO](https://www.veed.io/) is more of a platform company than a company specifically focused on AI Avatars. They offer additional products such as automatic subtitles and video editing software.
...
[**Try them out here**](https://www.veed.io/)**(aff)**

### Captions

![](https://cdn-images-1.medium.com/max/800/1*3W3riBkjui3rmrgG6Irfpg.png)
...
[Try them out here](https://www.captions.ai/)

### Some Insights

The first thing to notice is that this market is becoming extremely crowded. These companies are not the only ones—they are just the ones I have encountered. What’s more, there is very little to distinguish many of them. Many offer avatars that stand there and speak provided text. They mainly offer a price point that’s very often between $1.70-1.90 per minute. **If you are considering starting your own lip-sync company, I would advise you to develop a new USP**or face tough competition.

> If you removed all branding and formatting from each companies page, in many cases you could not tell the difference.

Despite similar use cases, companies offer a wide range of exciting technologies. There is a mix of work across [the different forms of lip sync models](https://medium.com/@jacksaunders909/the-many-forms-of-deep-audio-driven-video-dubbing-65dcf1e981e2). 2D and 3D are used, and deferred neural rendering, NeRFs, Gaussian splatting (early stages), and wav2lip-like models are all represented.
...
By [Dr Jack Saunders](https://medium.com/@jacksaunders909) on [May 25, 2024](https://medium.com/p/8a2fc4f318e2).

[Canonical link](https://medium.com/@jacksaunders909/the-definitive-guide-to-lip-sync-companies-8a2fc4f318e2)
