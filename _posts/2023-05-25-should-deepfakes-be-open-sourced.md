...
![Image Generated using DreamStudio](https://cdn-images-1.medium.com/max/800/1*nkLpu1_6rknU2P7EeVesEQ.png)
...
- **People will misuse them:**Regardless of how much we regulate or how good detection models are, there will be a small group of people that will use deepfakes for the worst possible reasons. From [revenge porn](https://www.technologyreview.com/2021/02/12/1018222/deepfake-revenge-porn-coming-ban/) to [disinformation](https://www.nytimes.com/2023/02/07/technology/artificial-intelligence-training-deepfake.html), there are some really nasty applications of this technology. If we open-source the models, we make it easier for all people to access them, which will undoubtedly cause harm. It is true that some of these bad actors will be able to do it anyway, particularly large criminal or national organisations, but the majority of people seeking to do harm may not have otherwise been able to do so, if there were no open-source models.
...
By [Dr Jack Saunders](https://medium.com/@jacksaunders909) on [May 25, 2023](https://medium.com/p/87d7644a0765).

[Canonical link](https://medium.com/@jacksaunders909/should-deepfakes-be-open-sourced-87d7644a0765)
